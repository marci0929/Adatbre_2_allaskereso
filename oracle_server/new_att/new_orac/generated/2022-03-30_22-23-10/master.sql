...
spool "new_orac_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_new_orac ...
DROP ROLE ROLE_new_orac ;
PROMPT Creating Role ROLE_new_orac ...
CREATE ROLE ROLE_new_orac ;
...
PROMPT Creating Primary Key Constraint PRIMARY_2 on table allas ... 
ALTER TABLE allas
...
GRANT ALL ON allas TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_8 on table diakszovetkezet ... 
...
GRANT ALL ON diakszovetkezet TO ROLE_new_orac;
...
GRANT ALL ON diakszovetkezetnel_van TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_11 on table diak_felhasznalo ... 
...
GRANT ALL ON diak_felhasznalo TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_5 on table egyeb_feltetelek ... 
...
GRANT ALL ON egyeb_feltetelek TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_3 on table fiokadatok ... 
...
GRANT ALL ON fiokadatok TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_9 on table helyszin ... 
...
GRANT ALL ON helyszin TO ROLE_new_orac;
...
GRANT ALL ON hirdeto TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_10 on table iskola ... 
ALTER TABLE iskola
...
GRANT ALL ON iskola TO ROLE_new_orac;
...
GRANT ALL ON jelentkezok TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_12 on table kapcsolat ... 
...
GRANT ALL ON kapcsolat TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_1 on table munkakor ... 
...
GRANT ALL ON munkakor TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_6 on table normal_felhasznalo ... 
...
GRANT ALL ON normal_felhasznalo TO ROLE_new_orac;
...
GRANT ALL ON regisztralt_allasok TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_7 on table szemelyes_adatok ... 
...
GRANT ALL ON szemelyes_adatok TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_13 on table vallalat ... 
...
GRANT ALL ON vallalat TO ROLE_new_orac;
...
PROMPT Creating Primary Key Constraint PRIMARY_4 on table vegzettseg ... 
...
GRANT ALL ON vegzettseg TO ROLE_new_orac;
