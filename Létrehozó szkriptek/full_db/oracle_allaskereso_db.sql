...
CREATE USER `allaskereso_db` IDENTIFIED BY `allaskereso_db`;
ALTER SESSION SET CURRENT_SCHEMA = allaskereso_db;

--
-- SQLINES DEMO *** ehhez a táblához `allas`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE allas';
EXCEPTION
...
(54, 'Domestic Outsourcing Business Development Executive', 'Genesis10 has an incredible opportunity for a Business Development Executive to join our highly-successful Domestic Outsourcing Service Line. The Business Development Executive will be responsible, on a national-level, for acquiring new client logos through consultative-selling of the full spectrum of Genesis10's Domestic Outsourcing services. Genesis10's core competencies in Domestic Outsourcing include, but is not limited to Infrastructure, Application Development, and Managed Services. Today, Genesis10 has 6 certified Delivery Centers from which we provide services from today to the Fortune 500. The Delivery Centers are located in: Atlanta, Cleveland, Dallas, Detroit, Kansas City, and Orlando. Becoming a Genesis10 Domestic Outsourcing Business Development Executive is an excellent career move. Here is what your sales colleagues like most about being in sales at Genesis10: * Genesis10 will not cap your earnings and will do everything we can to empower you to exceed your compensation goals. Many of our sales team members are some of the highest paid in the industry! * Genesis10 has a proven track record with referenceable clients providing Domestic Outsourcing Solutions and is considered an early-adopter * Genesis10's Delivery Center Network if 6 locations in Tier 2, 3 and 4 cities across the United States has been recognized by the market analysts as a key differentiator * You are not on your own! Get the support you need to drive your success: + Executive Level Support: You will have direct-access to the entire Genesis10 C-suite to assist you in opening up doors, creating sales strategy, and closing deals + Dedicated Marketing Team: You will have a marketing team focused on ensuring that you have the sales collateral required to support the business development lifecycle from sales presentations, to whitepapers to reusable RFP content * Genesis10 is not a job; it is a family and a career where you can enjoy sustained success. Most of our sales organization has been at Genesis10 for 7-15+ years * Experience work/life balance and trust from your organization. We realize that sales is a difficult role, requiring a lot of hard work and travel at times. Genesis10 is an organization that recognizes success is predicated on being in balance and enjoying the fruits of your labor How You Will Make a Difference:   As a Senior Business Development Executive, with experience selling outsourcing solutions, you will help drive domestic outsourcing business to Genesis10. * Utilizing existing relationships to drive Domestic Outsourcing business to Genesis10 * Using your 'hunter' sales approach, with the support of a top-tier delivery team, to open up new relationships and establish an optimal sales pipeline * Manage the end-to-end sales process for all pursuits, including lead-generation, client communications, on-site presentations, proposal development, and negotiation * Build strong internal relationships with Genesis10s' C-level executive team and the domestic outsourcing delivery team to gain optimal sales-support * Effectively collaborate with Genesis10's Delivery Center Operations Team to ensure that all awarded service proposals fully meet the client's needs Qualification Requirements:   * Multiple years of proven success selling global offshore or domestic/onshore solutions * Established network of Directors, Vice Presidents, and C-Level relationships to help drive business * Tenured history, having worked multiple years for a recent employer * Demonstrated ability to apply a sales "hunter approach to driving new business * Experience overseeing the buildout of proposals and contributing to the RFP process * Expert understanding of client outsourcing decision-criteria * Proven ability to work with remote or geographically disperse teams * Ability to travel to client-sites and Genesis10 Delivery Centers for onsite presentations Case when you've met these qualifications, I want to talk with you. If you are still reading, you must be interested! Reach out to me (Remster Bingham, Vice President of Recruiting rbingham@genesis10.com) today and gain a first-hand understanding of why Genesis10 is a career and not just a job! The Company:   Genesis10 is a professional technology services firm providing staffing, workforce optimization and domestic outsourcing solutions. If you are a high performing business or IT professional with solid, referenced experience, we want to meet you. Genesis10 recruiters and delivery professionals are highly accomplished career advocates, who get to know you beyond your resume to position you with the opportunities that fit your skills, experience and aspirations. We offer benefit options to fit your needs and a support staff that works with you from placement throughout your engagement providing career mentoring and support project after project. To learn more about Genesis10 and to view all our available career opportunities, please visit us at www.genesis10.com. Genesis10 is an Equal Opportunity Employer, M/F/D/V  Start Date: 07/05/2016' Then  23 Else  63, 10, 0, 6, '2022-10-17 00:00:00', 259622),
...
--
-- SQLINES DEMO *** k kiíratása `diakszovetkezet`
--

INSERT INTO diakszovetkezet (id, nev)
 SELECT 1, 'Diák-Meló Szövetkezet' FROM dual
 UNION ALL

 SELECT 2, 'Diák-Mind Szövetkezet' FROM dual
 UNION ALL

 SELECT 3, 'Fürgeláb Szövetkezet' FROM dual
 UNION ALL

 SELECT 4, 'Dolgos Diák Szövetkezet' FROM dual
 UNION ALL

 SELECT 5, 'DiákJobs Szövetkezet' FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `diakszovetkezetnel_van`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE diakszovetkezetnel_van';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `diakszovetkezetnel_van`
--

INSERT INTO diakszovetkezetnel_van (diakszovetkezet_id, diak_felhasznalo_id)
 ...
 SELECT 1, 17 FROM dual
 UNION ALL

 SELECT 5, 18 FROM dual
 UNION ALL

 SELECT 5, 19 FROM dual
 UNION ALL

 SELECT 3, 20 FROM dual
 UNION ALL

 SELECT 1, 21 FROM dual
 UNION ALL

 SELECT 3, 22 FROM dual
 UNION ALL
 ...
 SELECT 3, 26 FROM dual
 UNION ALL

 SELECT 3, 27 FROM dual
 UNION ALL

 SELECT 2, 28 FROM dual
 UNION ALL

 SELECT 1, 29 FROM dual
 UNION ALL
...
--
-- SQLINES DEMO *** ehhez a táblához `diak_felhasznalo`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE diak_felhasznalo';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `diak_felhasznalo`
--

INSERT INTO diak_felhasznalo (id, fiokadat_id, iskola_id, vallalat_id)
 SELECT 1, 117, 12, NULL FROM dual
 UNION ALL

 SELECT 2, 120, 14, NULL FROM dual
 UNION ALL

 SELECT 3, 121, 13, 6 FROM dual
 UNION ALL

 SELECT 4, 123, 10, NULL FROM dual
 UNION ALL

 SELECT 5, 126, 11, NULL FROM dual
 UNION ALL

 SELECT 6, 127, 15, NULL FROM dual
 UNION ALL

 SELECT 7, 128, 11, NULL FROM dual
 UNION ALL

 SELECT 8, 129, 9, NULL FROM dual
 UNION ALL

 SELECT 9, 131, 9, NULL FROM dual
 UNION ALL

 SELECT 10, 132, 2, NULL FROM dual
 UNION ALL

 SELECT 11, 133, 14, NULL FROM dual
 UNION ALL

 SELECT 12, 135, 7, NULL FROM dual
 UNION ALL

 SELECT 13, 137, 10, 9 FROM dual
 UNION ALL

 SELECT 14, 139, 10, NULL FROM dual
 UNION ALL

 SELECT 15, 144, 2, 5 FROM dual
 UNION ALL

 SELECT 16, 145, 10, NULL FROM dual
 UNION ALL

 SELECT 17, 148, 1, NULL FROM dual
 UNION ALL

 SELECT 18, 153, 9, 13 FROM dual
 UNION ALL

 SELECT 19, 155, 12, NULL FROM dual
 UNION ALL

 SELECT 20, 159, 10, 27 FROM dual
 UNION ALL

 SELECT 21, 160, 4, NULL FROM dual
 UNION ALL

 SELECT 22, 166, 2, 14 FROM dual
 UNION ALL

 SELECT 23, 168, 4, NULL FROM dual
 UNION ALL

 SELECT 24, 170, 8, NULL FROM dual
 UNION ALL

 SELECT 25, 171, 1, 20 FROM dual
 UNION ALL

 SELECT 26, 173, 8, NULL FROM dual
 UNION ALL

 SELECT 27, 176, 3, NULL FROM dual
 UNION ALL

 SELECT 28, 177, 12, NULL FROM dual
 UNION ALL

 SELECT 29, 178, 11, NULL FROM dual
 UNION ALL

 SELECT 30, 181, 5, 28 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `egyeb_feltetelek`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE egyeb_feltetelek';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
CREATE TABLE egyeb_feltetelek (
  id number(10) NOT NULL,
  kell_jogsi number(3) NOT NULL,
  munkatapasztalat_ev number(10) NOT NULL,
  egyeb_feltetelek varchar2(50) DEFAULT NULL
) ;

--
-- SQLINES DEMO *** k kiíratása `egyeb_feltetelek`
--

INSERT INTO egyeb_feltetelek (id, kell_jogsi, munkatapasztalat_ev, egyeb_feltetelek)
 SELECT 1, 0, 3, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 2, 1, 1, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 3, 0, 5, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 4, 1, 2, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 5, 1, 3, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 6, 1, 4, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 7, 0, 4, NULL FROM dual
 UNION ALL

 SELECT 8, 0, 1, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 9, 0, 3, NULL FROM dual
 UNION ALL

 SELECT 10, 1, 1, NULL FROM dual
 UNION ALL

 SELECT 11, 0, 3, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 12, 0, 5, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 13, 1, 1, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 14, 0, 1, NULL FROM dual
 UNION ALL

 SELECT 15, 1, 0, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 16, 1, 3, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 17, 0, 5, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 18, 1, 0, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 19, 1, 3, NULL FROM dual
 UNION ALL

 SELECT 20, 1, 4, NULL FROM dual
 UNION ALL

 SELECT 21, 0, 0, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 22, 0, 2, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 23, 0, 0, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 24, 0, 0, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 25, 1, 0, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 26, 0, 4, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 27, 0, 2, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 28, 1, 4, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 29, 0, 2, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 30, 0, 3, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 31, 0, 4, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 32, 0, 4, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 33, 0, 5, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 34, 1, 5, NULL FROM dual
 UNION ALL

 SELECT 35, 1, 1, 'Legalább egy előző munkahely' FROM dual
 UNION ALL

 SELECT 36, 1, 5, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 37, 0, 1, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 38, 0, 5, NULL FROM dual
 UNION ALL

 SELECT 39, 0, 2, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 40, 1, 4, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 41, 1, 3, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 42, 0, 1, 'Aktív hallgatói jogviszony' FROM dual
 UNION ALL

 SELECT 43, 1, 0, NULL FROM dual
 UNION ALL

 SELECT 44, 1, 2, NULL FROM dual
 UNION ALL

 SELECT 45, 0, 4, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 46, 0, 3, 'Érvényes számlaszám' FROM dual
 UNION ALL

 SELECT 47, 0, 1, 'Szakképesítés' FROM dual
 UNION ALL

 SELECT 48, 1, 3, 'Aktív hallgatói jogviszony' FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `fiokadatok`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE fiokadatok';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
CREATE TABLE fiokadatok (
  ...
  admin_e number(3) NOT NULL
) ;

--
-- SQLINES DEMO *** k kiíratása `fiokadatok`
--

INSERT INTO fiokadatok (id, email, jelszo, fiok_tipusa, szemelyes_adatok_id, admin_e)
 SELECT 1, 'admin@admin.com', 'admin', NULL, NULL, 1 FROM dual
 UNION ALL

 SELECT 2, 'heroine@outlook.com', 'yseYHG8v2B', 2, 83, 0 FROM dual
 UNION ALL

 SELECT 3, 'panolex@sbcglobal.net', '7MNp25f3nA', 2, 100, 0 FROM dual
 UNION ALL

 SELECT 4, 'alias@icloud.com', '4C3qZv9ENS', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 5, 'weidai@gmail.com', 'qRpTbUC6BX', 2, 3, 0 FROM dual
 UNION ALL

 SELECT 6, 'elflord@sbcglobal.net', 'Cn6Dt2cTj4', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 7, 'yzheng@yahoo.com', 'zgXaxf6nNe', 2, 48, 0 FROM dual
 UNION ALL

 SELECT 8, 'stevelim@aol.com', 'Q3fdhDgNCL', 2, 40, 0 FROM dual
 UNION ALL

 SELECT 9, 'houle@att.net', 'Kg8Fs2D9n5', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 10, 'dinther@msn.com', 'UgYG3eFSaM', 2, 20, 0 FROM dual
 UNION ALL

 SELECT 11, 'lstein@icloud.com', '8ZFRExvbAk', 2, 85, 0 FROM dual
 UNION ALL

 SELECT 12, 'thaljef@msn.com', 'JCaE4GABcw', 2, 9, 0 FROM dual
 UNION ALL

 SELECT 13, 'gboss@icloud.com', 'szYFLSrR7D', 2, 2, 0 FROM dual
 UNION ALL

 SELECT 14, 'campbell@outlook.com', 'JGH5mQj9tF', 2, 35, 0 FROM dual
 UNION ALL

 SELECT 15, 'muadip@outlook.com', 'Kfejy4mnvq', 2, 92, 0 FROM dual
 UNION ALL

 SELECT 16, 'portele@comcast.net', 'gr6KV5b2j3', 2, 31, 0 FROM dual
 UNION ALL

 SELECT 17, 'geeber@verizon.net', '4KvsjkrEhP', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 18, 'munson@outlook.com', 'jFugYB5TrV', 2, 41, 0 FROM dual
 UNION ALL

 SELECT 19, 'mglee@msn.com', 'rC3xdptWUN', 2, 91, 0 FROM dual
 UNION ALL

 SELECT 20, 'sravani@comcast.net', '8ANMCgYwBX', 2, 4, 0 FROM dual
 UNION ALL

 SELECT 21, 'brbarret@gmail.com', 'B7DZSFhLa3', 2, 15, 0 FROM dual
 UNION ALL

 SELECT 22, 'donev@aol.com', 'PFe6tGBVRL', 2, 69, 0 FROM dual
 UNION ALL

 SELECT 23, 'nasor@att.net', 'Y2ywEDPRav', 2, 1, 0 FROM dual
 UNION ALL

 SELECT 24, 'rfoley@aol.com', 'QfBL9vRrhS', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 25, 'njpayne@comcast.net', 'nW5v9QYR2p', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 26, 'mgemmons@optonline.net', 'Q2rc79RLMK', 2, 10, 0 FROM dual
 UNION ALL

 SELECT 27, 'rwelty@live.com', 'HPZtdN4w5D', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 28, 'sartak@yahoo.ca', 'MT2PUcuRre', 2, 79, 0 FROM dual
 UNION ALL

 SELECT 29, 'dialworld@hotmail.com', 'Su5Havx8wp', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 30, 'johnbob@verizon.net', 'YuLDs9c7zb', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 31, 'luvirini@sbcglobal.net', 'LPvTnJC6HK', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 32, 'jbailie@optonline.net', '2uJcFRrh5Q', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 33, 'danneng@live.com', 'nHGKZq8P5D', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 34, 'conteb@aol.com', 'VTLmF5eBsN', 2, 93, 0 FROM dual
 UNION ALL

 SELECT 35, 'kewley@sbcglobal.net', 'cSF78YvyZe', 2, 24, 0 FROM dual
 UNION ALL

 SELECT 36, 'suresh@comcast.net', 'Jc4DgFmd6j', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 37, 'denism@yahoo.ca', '2DgxzvtLR9', 2, 8, 0 FROM dual
 UNION ALL

 SELECT 38, 'jonas@outlook.com', 'ZqKTuA9S6m', 2, 38, 0 FROM dual
 UNION ALL

 SELECT 39, 'munson@aol.com', 'LdFwtK7aZY', 2, 46, 0 FROM dual
 UNION ALL

 SELECT 40, 'donev@icloud.com', 'K6CXvDWhuq', 2, 78, 0 FROM dual
 UNION ALL

 SELECT 41, 'aibrahim@me.com', 'DhgrPUw7ab', 2, 53, 0 FROM dual
 UNION ALL

 SELECT 42, 'balchen@att.net', 'mjR8FrptJQ', 2, 44, 0 FROM dual
 UNION ALL

 SELECT 43, 'improv@yahoo.com', 'nLHcVpsx5y', 2, 58, 0 FROM dual
 UNION ALL

 SELECT 44, 'mchugh@icloud.com', 'AQ93Zba7hH', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 45, 'vmalik@msn.com', 'wAJy7SkHaC', 2, 43, 0 FROM dual
 UNION ALL

 SELECT 46, 'thomasj@yahoo.ca', 'NnE8J3CfkG', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 47, 'thrymm@att.net', 'sKkQr38FmH', 2, 72, 0 FROM dual
 UNION ALL

 SELECT 48, 'eidac@aol.com', 'zsBVt3dFDH', 2, 34, 0 FROM dual
 UNION ALL

 SELECT 49, 'bartlett@yahoo.com', 'z7xTg5yHsq', 2, 97, 0 FROM dual
 UNION ALL

 SELECT 50, 'rkobes@msn.com', 'nf8uCWAwLK', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 51, 'fairbank@mac.com', '8VbsgqChQz', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 52, 'jonathan@gmail.com', 'NhKU7FLgWv', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 53, 'kramulous@aol.com', 'f6wymY52ek', 2, 51, 0 FROM dual
 UNION ALL

 SELECT 54, 'muzzy@comcast.net', '5Kc4EprFMZ', 2, 6, 0 FROM dual
 UNION ALL

 SELECT 55, 'spadkins@yahoo.com', 'j6zHr9RXyA', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 56, 'petersko@gmail.com', 'aL9ZjNDdcG', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 57, 'pspoole@gmail.com', 'ex3NsBdptu', 2, 80, 0 FROM dual
 UNION ALL

 SELECT 58, 'jdhildeb@icloud.com', 'zWqU7r385M', 2, 26, 0 FROM dual
 UNION ALL

 SELECT 59, 'jeteve@live.com', 'wEHhUMuxD2', 2, 87, 0 FROM dual
 UNION ALL

 SELECT 60, 'kayvonf@att.net', 'fsnNV3mrKz', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 61, 'parents@outlook.com', 'L8f5kKXwpx', 2, 42, 0 FROM dual
 UNION ALL

 SELECT 62, 'zilla@yahoo.com', 'TfRrUCaXF6', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 63, 'mbrown@icloud.com', 'N54jRFc2ZE', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 64, 'hikoza@optonline.net', 'UrLE4kVYtn', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 65, 'curly@live.com', 'cPCGBu2xFQ', 2, 16, 0 FROM dual
 UNION ALL

 SELECT 66, 'crowl@yahoo.ca', '94kvZm5eS3', 2, 37, 0 FROM dual
 UNION ALL

 SELECT 67, 'djpig@yahoo.com', 'bxP8f5yWs2', 2, 5, 0 FROM dual
 UNION ALL

 SELECT 68, 'gozer@yahoo.ca', 'v7wj9qDt4F', 2, 59, 0 FROM dual
 UNION ALL

 SELECT 69, 'bartlett@optonline.net', '2Jv6nt8Dbm', 2, 95, 0 FROM dual
 UNION ALL

 SELECT 70, 'panolex@gmail.com', 'NPXvf2wqsU', 2, 62, 0 FROM dual
 UNION ALL

 SELECT 71, 'mosses@icloud.com', 'XK5CMb2cQs', 2, 61, 0 FROM dual
 UNION ALL

 SELECT 72, 'jandrese@sbcglobal.net', 'CVmY2bgNHQ', 2, 63, 0 FROM dual
 UNION ALL

 SELECT 73, 'bastian@hotmail.com', 'bywUGdZgE8', 2, 19, 0 FROM dual
 UNION ALL

 SELECT 74, 'rwelty@yahoo.ca', 'sjJT8zdY26', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 75, 'aracne@msn.com', 'DJ5cLuaZx3', 2, 7, 0 FROM dual
 UNION ALL

 SELECT 76, 'bescoto@sbcglobal.net', 'HX5w34CWbQ', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 77, 'magusnet@verizon.net', 'y9n8CmBA25', 2, 74, 0 FROM dual
 UNION ALL

 SELECT 78, 'duncand@optonline.net', 'RKMU5YymEs', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 79, 'goresky@sbcglobal.net', 'pdUQr8Rjwt', 2, 89, 0 FROM dual
 UNION ALL

 SELECT 80, 'jonathan@gmail.com', 'tYPEn6yzXZ', 2, 55, 0 FROM dual
 UNION ALL

 SELECT 81, 'dawnsong@gmail.com', 'eFGSRz42pn', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 82, 'jusdisgi@outlook.com', '7QbeFqhH4M', 2, 82, 0 FROM dual
 UNION ALL

 SELECT 83, 'aschmitz@gmail.com', 'BrMzKtb5aN', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 84, 'kmiller@gmail.com', 'yEfxDNLkV6', 2, 88, 0 FROM dual
 UNION ALL

 SELECT 85, 'mkearl@verizon.net', '9nuZ3EfKFC', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 86, 'chance@hotmail.com', 'PLvmTtqHs6', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 87, 'fmerges@msn.com', 'pLcGhakAN5', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 88, 'fallorn@yahoo.com', 'v5zTtywgC6', 2, 39, 0 FROM dual
 UNION ALL

 SELECT 89, 'bigmauler@verizon.net', 'QEGA5VSb7K', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 90, 'dsugal@mac.com', 'kAbWhU4gKQ', 2, 54, 0 FROM dual
 UNION ALL

 SELECT 91, 'shrapnull@live.com', 'tUg2eMnQGj', 2, 98, 0 FROM dual
 UNION ALL

 SELECT 92, 'makarow@gmail.com', 'AY2Rfyh7WZ', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 93, 'cfhsoft@optonline.net', '3JdEZC7g2H', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 94, 'crowl@yahoo.com', '7tTvnEpsx9', 2, 75, 0 FROM dual
 UNION ALL

 SELECT 95, 'mcnihil@sbcglobal.net', 'NKSshByL6f', 2, 32, 0 FROM dual
 UNION ALL

 SELECT 96, 'hllam@aol.com', '7MpReWSzuJ', 2, 45, 0 FROM dual
 UNION ALL

 SELECT 97, 'laird@me.com', 'CaqDudx3cV', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 98, 'qrczak@sbcglobal.net', 'CsWJRbg4zd', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 99, 'scarlet@verizon.net', 'd5Qmwr3xn4', 2, 22, 0 FROM dual
 UNION ALL

 SELECT 100, 'ivoibs@aol.com', '4SVzTkQC8j', 2, 23, 0 FROM dual
 UNION ALL

 SELECT 101, 'fmerges@mac.com', 've7kjcnMQA', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 102, 'gamma@msn.com', 'fP6EU83vAg', 2, 12, 0 FROM dual
 UNION ALL

 SELECT 103, 'maradine@mac.com', 'Y9yJUpMEvq', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 104, 'rmcfarla@sbcglobal.net', 'e4zPJKshrc', 2, 65, 0 FROM dual
 UNION ALL

 SELECT 105, 'crusader@live.com', 'wQba5DKqPZ', 2, 94, 0 FROM dual
 UNION ALL

 SELECT 106, 'bmorrow@sbcglobal.net', 'RVP5npMCvE', 2, 76, 0 FROM dual
 UNION ALL

 SELECT 107, 'gmcgath@verizon.net', 'pmF4q2MetY', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 108, 'rmcfarla@sbcglobal.net', '2HkqQYWZgR', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 109, 'houle@comcast.net', 'NX8gzDfMFv', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 110, 'mbrown@live.com', 'HwymTeV38d', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 111, 'durist@msn.com', '5dKywtUnxN', 2, 50, 0 FROM dual
 UNION ALL

 SELECT 112, 'dpitts@yahoo.ca', 'xrFWkbvKR8', 2, 77, 0 FROM dual
 UNION ALL

 SELECT 113, 'bartlett@aol.com', 'nCzMjtp83E', 2, 29, 0 FROM dual
 UNION ALL

 SELECT 114, 'odlyzko@comcast.net', 'Le4dJN7pPH', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 115, 'lstein@yahoo.com', 'gCkMDBQpq9', 2, 33, 0 FROM dual
 UNION ALL

 SELECT 116, 'keiji@aol.com', 'TqQ9W3NsSU', 2, 96, 0 FROM dual
 UNION ALL

 SELECT 117, 'dogdude@live.com', 'KRgWsL9YXv', 3, 64, 0 FROM dual
 UNION ALL

 SELECT 118, 'jesse@outlook.com', 'fEhtm87zHd', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 119, 'rmcfarla@att.net', 'G7TV8uD34E', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 120, 'burns@comcast.net', 'rKL4gNAX3W', 3, 70, 0 FROM dual
 UNION ALL

 SELECT 121, 'joglo@gmail.com', 'M4YFCv3bXG', 3, 66, 0 FROM dual
 UNION ALL

 SELECT 122, 'farber@sbcglobal.net', '54jmFpGxM2', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 123, 'kudra@aol.com', '7RJCr85mwx', 3, 27, 0 FROM dual
 UNION ALL

 SELECT 124, 'erynf@comcast.net', '9YB64EUgRP', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 125, 'arachne@icloud.com', 'BFUD7usndj', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 126, 'cantu@sbcglobal.net', 'kgvMW6LVC9', 3, 57, 0 FROM dual
 UNION ALL

 SELECT 127, 'scarlet@hotmail.com', 'xcemtY5Ggs', 3, 21, 0 FROM dual
 UNION ALL

 SELECT 128, 'microfab@msn.com', 'pVZgYHQ2Mn', 3, 56, 0 FROM dual
 UNION ALL

 SELECT 129, 'ilikered@aol.com', 'st3jvHMpZB', 3, 71, 0 FROM dual
 UNION ALL

 SELECT 130, 'sburke@live.com', 'ZHhwtKrq7F', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 131, 'bockelboy@yahoo.com', 'Tf2rGMNWPw', 3, 84, 0 FROM dual
 UNION ALL

 SELECT 132, 'overbom@att.net', '7cSXFqQkaG', 3, 14, 0 FROM dual
 UNION ALL

 SELECT 133, 'kiddailey@icloud.com', 'L7BtqTQjWp', 3, 13, 0 FROM dual
 UNION ALL

 SELECT 134, 'jadavis@mac.com', '5wxRbsJfQA', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 135, 'wagnerch@comcast.net', 'ZxsRywQv28', 3, 90, 0 FROM dual
 UNION ALL

 SELECT 136, 'lamprecht@att.net', 'WuJEAH3US9', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 137, 'formis@yahoo.com', '3sEbHpfjqr', 3, 36, 0 FROM dual
 UNION ALL

 SELECT 138, 'crowemojo@att.net', 'yGsuhfa4Tr', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 139, 'jfinke@aol.com', 'LVwfS36Jhr', 3, 47, 0 FROM dual
 UNION ALL

 SELECT 140, 'rtanter@mac.com', 'n9fzLXUmuY', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 141, 'pemungkah@icloud.com', '3WpXH5DyfG', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 142, 'aibrahim@optonline.net', 'hmNH8MyWgF', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 143, 'rcwil@msn.com', 'UqjPDyQXf2', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 144, 'sisyphus@optonline.net', 'ZBVkXsH3GL', 3, 67, 0 FROM dual
 UNION ALL

 SELECT 145, 'nimaclea@hotmail.com', 'aeU24WSdFT', 3, 73, 0 FROM dual
 UNION ALL

 SELECT 146, 'eurohack@att.net', 'G4UJQpgRYr', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 147, 'pkplex@verizon.net', '8pRqegf3SU', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 148, 'jbailie@yahoo.com', 'q3rm7yHgpu', 3, 81, 0 FROM dual
 UNION ALL

 SELECT 149, 'stomv@comcast.net', 'PLgy5dTp3f', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 150, 'timtroyr@me.com', 'WZj3JG2xKm', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 151, 'tmccarth@hotmail.com', '2K5AxJHmha', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 152, 'eabrown@mac.com', 'DyAd6YHqG9', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 153, 'cyrus@mac.com', 'KtaRL4AEhP', 3, 49, 0 FROM dual
 UNION ALL

 SELECT 154, 'jfmulder@yahoo.com', 'sD28mT36By', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 155, 'dunstan@gmail.com', 'T8vHZeCp9j', 3, 68, 0 FROM dual
 UNION ALL

 SELECT 156, 'bester@mac.com', 'tQPUjyRT9F', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 157, 'plover@att.net', 'TP2yHYgCW6', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 158, 'isotopian@yahoo.ca', 'qc3rjW8Hew', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 159, 'pkilab@att.net', 'sTz5e7849w', 3, 28, 0 FROM dual
 UNION ALL

 SELECT 160, 'vlefevre@comcast.net', 'Vz8wXS9Q6N', 3, 17, 0 FROM dual
 UNION ALL

 SELECT 161, 'janneh@mac.com', 'MNJbs6wQ2C', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 162, 'kassiesa@live.com', 'Epn3dGw9zN', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 163, 'fluffy@verizon.net', 'UGW6QH7gap', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 164, 'schwaang@gmail.com', 'aDJ3uEbwVK', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 165, 'hahiss@aol.com', 'eZjA8XKNSV', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 166, 'goresky@optonline.net', '4vALJzuEFt', 3, 86, 0 FROM dual
 UNION ALL

 SELECT 167, 'pemungkah@me.com', 'YPXEM6zD2u', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 168, 'matsn@msn.com', 'P3U8KgHcDq', 3, 30, 0 FROM dual
 UNION ALL

 SELECT 169, 'hoyer@yahoo.com', 'WfES9VkLAc', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 170, 'dburrows@optonline.net', 'DTge3CWBSU', 3, 100, 0 FROM dual
 UNION ALL

 SELECT 171, 'symbolic@mac.com', '7dLjWNhH2b', 3, 11, 0 FROM dual
 UNION ALL

 SELECT 172, 'andrei@yahoo.com', 'LDxygrm7fp', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 173, 'zeller@icloud.com', '7X428WNTKw', 3, 99, 0 FROM dual
 UNION ALL

 SELECT 174, 'moinefou@msn.com', '2vTLWkwaVm', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 175, 'thaljef@att.net', 'kjN3p4yGHv', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 176, 'pdbaby@yahoo.ca', 'jcdGEKqYP7', 3, 18, 0 FROM dual
 UNION ALL

 SELECT 177, 'pedwards@yahoo.ca', 'P2rS8WFfKn', 3, 52, 0 FROM dual
 UNION ALL

 SELECT 178, 'aibrahim@me.com', 'QqHB6nbcD3', 3, 60, 0 FROM dual
 UNION ALL

 SELECT 179, 'mallanmba@me.com', 'QnMqJ7HvmB', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 180, 'rgarcia@optonline.net', 'ph6KQWeaF4', 1, NULL, 0 FROM dual
 UNION ALL

 SELECT 181, 'jimmichie@verizon.net', 'hN64u5arLD', 3, 25, 0 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `helyszin`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE helyszin';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
CREATE TABLE helyszin (
  ...
  tavolrol_vegezheto_e number(3) NOT NULL
) ;

--
-- SQLINES DEMO *** k kiíratása `helyszin`
--

INSERT INTO helyszin (id, orszag, varos, tavolrol_vegezheto_e)
 SELECT 1, 'Magyarország', 'Budapest', 0 FROM dual
 UNION ALL

 SELECT 2, 'Magyarország', 'Debrecen', 0 FROM dual
 UNION ALL

 SELECT 3, 'Magyarország', 'Szeged', 1 FROM dual
 UNION ALL

 SELECT 4, 'Magyarország', 'Pécs', 1 FROM dual
 UNION ALL

 SELECT 5, 'Magyarország', 'Sopron', 0 FROM dual
 UNION ALL

 SELECT 6, 'Magyarország', 'Szombathely', 0 FROM dual
 UNION ALL

 SELECT 7, 'Magyarország', 'Kecskemét', 0 FROM dual
 UNION ALL

 SELECT 8, 'Magyarország', 'Siófok', 0 FROM dual
 UNION ALL

 SELECT 9, 'Magyarország', 'Miskolc', 0 FROM dual
 UNION ALL

 SELECT 10, 'Magyarország', 'Győr', 0 FROM dual
 UNION ALL

 SELECT 11, 'Magyarország', 'Szolnok', 0 FROM dual
 UNION ALL

 SELECT 12, 'Magyarország', 'Kaposvár', 0 FROM dual
 UNION ALL

 SELECT 13, 'Magyarország', 'Veszprém', 1 FROM dual
 UNION ALL

 SELECT 14, 'Magyarország', 'Békéscsaba', 1 FROM dual
 UNION ALL

 SELECT 15, 'Magyarország', 'Székesfehérvár', 1 FROM dual
 UNION ALL

 SELECT 16, 'Magyarország', 'Baja', 1 FROM dual
 UNION ALL

 SELECT 17, 'Magyarország', 'Cegléd', 0 FROM dual
 UNION ALL

 SELECT 18, 'Magyarország', 'Csongrád', 0 FROM dual
 UNION ALL

 SELECT 19, 'Magyarország', 'Gyula', 0 FROM dual
 UNION ALL

 SELECT 20, 'Magyarország', 'Esztergom', 1 FROM dual
 UNION ALL

 SELECT 21, 'Magyarország', 'Dunaújváros', 1 FROM dual
 UNION ALL

 SELECT 22, 'Magyarország', 'Dunakeszi', 1 FROM dual
 UNION ALL

 SELECT 23, 'Magyarország', 'Érd', 0 FROM dual
 UNION ALL

 SELECT 24, 'Magyarország', 'Hatvan', 0 FROM dual
 UNION ALL

 SELECT 25, 'Magyarország', 'Hódmezővásárhely', 0 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `hirdeto`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE hirdeto';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `hirdeto`
--

INSERT INTO hirdeto (id, fiokadatok_id, vallalat_id)
 SELECT 1, 4, 18 FROM dual
 UNION ALL

 SELECT 2, 6, 22 FROM dual
 UNION ALL

 SELECT 3, 9, 1 FROM dual
 UNION ALL

 SELECT 4, 17, 4 FROM dual
 UNION ALL

 SELECT 5, 24, 10 FROM dual
 UNION ALL

 SELECT 6, 25, 14 FROM dual
 UNION ALL

 SELECT 7, 27, 26 FROM dual
 UNION ALL

 SELECT 8, 29, 1 FROM dual
 UNION ALL

 SELECT 9, 30, 20 FROM dual
 UNION ALL

 SELECT 10, 31, 16 FROM dual
 UNION ALL

 SELECT 11, 32, 10 FROM dual
 UNION ALL

 SELECT 12, 33, 18 FROM dual
 UNION ALL

 SELECT 13, 36, 12 FROM dual
 UNION ALL

 SELECT 14, 44, 8 FROM dual
 UNION ALL

 SELECT 15, 46, 21 FROM dual
 UNION ALL

 SELECT 16, 50, 29 FROM dual
 UNION ALL

 SELECT 17, 51, 25 FROM dual
 UNION ALL

 SELECT 18, 52, 1 FROM dual
 UNION ALL

 SELECT 19, 55, 18 FROM dual
 UNION ALL

 SELECT 20, 56, 7 FROM dual
 UNION ALL

 SELECT 21, 60, 18 FROM dual
 UNION ALL

 SELECT 22, 62, 25 FROM dual
 UNION ALL

 SELECT 23, 63, 27 FROM dual
 UNION ALL

 SELECT 24, 64, 7 FROM dual
 UNION ALL

 SELECT 25, 74, 18 FROM dual
 UNION ALL

 SELECT 26, 76, 22 FROM dual
 UNION ALL

 SELECT 27, 78, 13 FROM dual
 UNION ALL

 SELECT 28, 81, 24 FROM dual
 UNION ALL

 SELECT 29, 83, 30 FROM dual
 UNION ALL

 SELECT 30, 85, 4 FROM dual
 UNION ALL

 SELECT 31, 86, 24 FROM dual
 UNION ALL

 SELECT 32, 87, 12 FROM dual
 UNION ALL

 SELECT 33, 89, 2 FROM dual
 UNION ALL

 SELECT 34, 92, 25 FROM dual
 UNION ALL

 SELECT 35, 93, 18 FROM dual
 UNION ALL

 SELECT 36, 97, 26 FROM dual
 UNION ALL

 SELECT 37, 98, 28 FROM dual
 UNION ALL

 SELECT 38, 101, 1 FROM dual
 UNION ALL

 SELECT 39, 103, 19 FROM dual
 UNION ALL

 SELECT 40, 107, 6 FROM dual
 UNION ALL

 SELECT 41, 108, 23 FROM dual
 UNION ALL

 SELECT 42, 109, 11 FROM dual
 UNION ALL

 SELECT 43, 110, 26 FROM dual
 UNION ALL

 SELECT 44, 114, 7 FROM dual
 UNION ALL

 SELECT 45, 118, 28 FROM dual
 UNION ALL

 SELECT 46, 119, 29 FROM dual
 UNION ALL

 SELECT 47, 122, 10 FROM dual
 UNION ALL

 SELECT 48, 124, 9 FROM dual
 UNION ALL

 SELECT 49, 125, 25 FROM dual
 UNION ALL

 SELECT 50, 130, 5 FROM dual
 UNION ALL

 SELECT 51, 134, 19 FROM dual
 UNION ALL

 SELECT 52, 136, 30 FROM dual
 UNION ALL

 SELECT 53, 138, 22 FROM dual
 UNION ALL

 SELECT 54, 140, 7 FROM dual
 UNION ALL

 SELECT 55, 141, 18 FROM dual
 UNION ALL

 SELECT 56, 142, 3 FROM dual
 UNION ALL

 SELECT 57, 143, 17 FROM dual
 UNION ALL

 SELECT 58, 146, 20 FROM dual
 UNION ALL

 SELECT 59, 147, 19 FROM dual
 UNION ALL

 SELECT 60, 149, 4 FROM dual
 UNION ALL

 SELECT 61, 150, 12 FROM dual
 UNION ALL

 SELECT 62, 151, 26 FROM dual
 UNION ALL

 SELECT 63, 152, 26 FROM dual
 UNION ALL

 SELECT 64, 154, 23 FROM dual
 UNION ALL

 SELECT 65, 156, 2 FROM dual
 UNION ALL

 SELECT 66, 157, 29 FROM dual
 UNION ALL

 SELECT 67, 158, 17 FROM dual
 UNION ALL

 SELECT 68, 161, 27 FROM dual
 UNION ALL

 SELECT 69, 162, 24 FROM dual
 UNION ALL

 SELECT 70, 163, 20 FROM dual
 UNION ALL

 SELECT 71, 164, 24 FROM dual
 UNION ALL

 SELECT 72, 165, 7 FROM dual
 UNION ALL

 SELECT 73, 167, 19 FROM dual
 UNION ALL

 SELECT 74, 169, 17 FROM dual
 UNION ALL

 SELECT 75, 172, 30 FROM dual
 UNION ALL

 SELECT 76, 174, 19 FROM dual
 UNION ALL

 SELECT 77, 175, 18 FROM dual
 UNION ALL

 SELECT 78, 179, 21 FROM dual
 UNION ALL

 SELECT 79, 180, 22 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `iskola`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE iskola';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `iskola`
--

INSERT INTO iskola (id, nev, varhato_befejezes)
 SELECT 1, 'Állatorvostudományi Egyetem', 2024 FROM dual
 UNION ALL

 SELECT 2, 'Bolyai János Gimnázium', 2023 FROM dual
 UNION ALL

 SELECT 3, 'Kandó Kálmán Szakközépiskola', 2025 FROM dual
 UNION ALL

 SELECT 4, 'Állatorvostudományi Egyetem', 2026 FROM dual
 UNION ALL

 SELECT 5, 'Szegedi Tudományegyetem', 2023 FROM dual
 UNION ALL

 SELECT 6, 'Szegedi Tudományegyetem', 2026 FROM dual
 UNION ALL

 SELECT 7, 'Bolyai János Gimnázium', 2024 FROM dual
 UNION ALL

 SELECT 8, 'Szegedi Tudományegyetem', 2022 FROM dual
 UNION ALL

 SELECT 9, 'Kandó Kálmán Szakközépiskola', 2023 FROM dual
 UNION ALL

 SELECT 10, 'Állatorvostudományi Egyetem', 2027 FROM dual
 UNION ALL

 SELECT 11, 'Állatorvostudományi Egyetem', 2022 FROM dual
 UNION ALL

 SELECT 12, 'Bolyai János Gimnázium', 2024 FROM dual
 UNION ALL

 SELECT 13, 'Szegedi Tudományegyetem', 2022 FROM dual
 UNION ALL

 SELECT 14, 'Kandó Kálmán Szakközépiskola', 2025 FROM dual
 UNION ALL

 SELECT 15, 'Állatorvostudományi Egyetem', 2026 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `jelentkezok`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE jelentkezok';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `jelentkezok`
--

INSERT INTO jelentkezok (allas_id, normal_felhasznalo_id)
 SELECT 14, 4 FROM dual
 UNION ALL

 SELECT 93, 49 FROM dual
 UNION ALL

 SELECT 13, 11 FROM dual
 UNION ALL

 SELECT 37, 29 FROM dual
 UNION ALL

 SELECT 64, 38 FROM dual
 UNION ALL

 SELECT 71, 60 FROM dual
 UNION ALL

 SELECT 65, 11 FROM dual
 UNION ALL

 SELECT 15, 62 FROM dual
 UNION ALL

 SELECT 7, 45 FROM dual
 UNION ALL

 SELECT 9, 25 FROM dual
 UNION ALL

 SELECT 56, 56 FROM dual
 UNION ALL

 SELECT 63, 28 FROM dual
 UNION ALL

 SELECT 39, 68 FROM dual
 UNION ALL

 SELECT 73, 34 FROM dual
 UNION ALL

 SELECT 18, 18 FROM dual
 UNION ALL

 SELECT 36, 21 FROM dual
 UNION ALL

 SELECT 73, 19 FROM dual
 UNION ALL

 SELECT 97, 51 FROM dual
 UNION ALL

 SELECT 5, 31 FROM dual
 UNION ALL

 SELECT 57, 24 FROM dual
 UNION ALL

 SELECT 75, 67 FROM dual
 UNION ALL

 SELECT 72, 49 FROM dual
 UNION ALL

 SELECT 15, 45 FROM dual
 UNION ALL

 SELECT 48, 71 FROM dual
 UNION ALL

 SELECT 22, 42 FROM dual
 UNION ALL

 SELECT 29, 67 FROM dual
 UNION ALL

 SELECT 31, 27 FROM dual
 UNION ALL

 SELECT 19, 68 FROM dual
 UNION ALL

 SELECT 11, 35 FROM dual
 UNION ALL

 SELECT 72, 71 FROM dual
 UNION ALL

 SELECT 35, 54 FROM dual
 UNION ALL

 SELECT 53, 28 FROM dual
 UNION ALL

 SELECT 65, 56 FROM dual
 UNION ALL

 SELECT 34, 55 FROM dual
 UNION ALL

 SELECT 12, 4 FROM dual
 UNION ALL

 SELECT 9, 64 FROM dual
 UNION ALL

 SELECT 3, 18 FROM dual
 UNION ALL

 SELECT 63, 19 FROM dual
 UNION ALL

 SELECT 82, 37 FROM dual
 UNION ALL

 SELECT 69, 55 FROM dual
 UNION ALL

 SELECT 97, 68 FROM dual
 UNION ALL

 SELECT 96, 42 FROM dual
 UNION ALL

 SELECT 57, 44 FROM dual
 UNION ALL

 SELECT 1, 43 FROM dual
 UNION ALL

 SELECT 52, 17 FROM dual
 UNION ALL

 SELECT 28, 38 FROM dual
 UNION ALL

 SELECT 8, 2 FROM dual
 UNION ALL

 SELECT 78, 6 FROM dual
 UNION ALL

 SELECT 86, 46 FROM dual
 UNION ALL

 SELECT 21, 22 FROM dual
 UNION ALL

 SELECT 61, 30 FROM dual
 UNION ALL

 SELECT 18, 71 FROM dual
 UNION ALL

 SELECT 37, 71 FROM dual
 UNION ALL

 SELECT 5, 25 FROM dual
 UNION ALL

 SELECT 52, 42 FROM dual
 UNION ALL

 SELECT 50, 18 FROM dual
 UNION ALL

 SELECT 39, 7 FROM dual
 UNION ALL

 SELECT 88, 52 FROM dual
 UNION ALL

 SELECT 30, 14 FROM dual
 UNION ALL

 SELECT 60, 68 FROM dual
 UNION ALL

 SELECT 59, 35 FROM dual
 UNION ALL

 SELECT 13, 2 FROM dual
 UNION ALL

 SELECT 83, 29 FROM dual
 UNION ALL

 SELECT 47, 52 FROM dual
 UNION ALL

 SELECT 44, 39 FROM dual
 UNION ALL

 SELECT 93, 67 FROM dual
 UNION ALL

 SELECT 43, 70 FROM dual
 UNION ALL

 SELECT 5, 20 FROM dual
 UNION ALL

 SELECT 88, 56 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `kapcsolat`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE kapcsolat';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `kapcsolat`
--

INSERT INTO kapcsolat (id, nev, email, telefon)
 SELECT 1, 'Gáspár Mihály', 'gasparmihaly@gmail.com', 620516675 FROM dual
 UNION ALL

 SELECT 2, 'Veres Kálmán', 'vereskalman@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 3, 'Kelemen Ferenc', 'kelemenferenc@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 4, 'Fülöp Rajmund', 'fuloprajmund@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 5, 'Pataki Bálint', 'patakibalint@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 6, 'Tamás Márkó', 'tamasmarko@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 7, 'Molnár István', 'molnaristvan@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 8, 'Faragó Levente', 'faragolevente@gmail.com', 61481971 FROM dual
 UNION ALL

 SELECT 9, 'Fehér Ákos', 'feherakos@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 10, 'Balázs Károly', 'balazskaroly@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 11, 'Székely Flórián', 'szekelyflorian@gmail.com', 670574882 FROM dual
 UNION ALL

 SELECT 12, 'Vass Ádám', 'vassadam@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 13, 'Takács Gergő', 'takacsgergo@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 14, 'Molnár Dalma', 'molnardalma@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 15, 'Novák Lilla', 'novaklilla@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 16, 'Kis Georgina', 'kisgeorgina@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 17, 'Biró Dorka', 'birodorka@gmail.com', 62091156 FROM dual
 UNION ALL

 SELECT 18, 'Takács Réka', 'takacsreka@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 19, 'Fülöp Regina', 'fulopregina@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 20, 'Gáspár Ágnes', 'gasparagnes@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 21, 'Jakab Dominika', 'jakabdominika@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 22, 'Egyed Kíra', 'egyedkira@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 23, 'Pintér Éva', 'pintereva@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 24, 'Vincze Sára', 'vinczeSara@gmail.com', 2147483647 FROM dual
 UNION ALL

 SELECT 25, 'Halász Fruzsina', 'halaszfruzsina@gmail.com', 2147483647 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `munkakor`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE munkakor';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `munkakor`
--

INSERT INTO munkakor (id, allas_tipusa, szuksegse_vegzettseg, egyeb_feltetelek_id)
 SELECT 1, 'Fizikai', 'Érettségi', NULL FROM dual
 UNION ALL

 SELECT 2, 'Fizikai', 'Érettségi', 27 FROM dual
 UNION ALL

 SELECT 3, 'Fizikai', 'Érettségi', 21 FROM dual
 UNION ALL

 SELECT 4, 'Fizikai', 'Érettségi', 46 FROM dual
 UNION ALL

 SELECT 5, 'Fizikai', 'Érettségi', 47 FROM dual
 UNION ALL

 SELECT 6, 'Fizikai', '8 Általános', NULL FROM dual
 UNION ALL

 SELECT 7, 'Fizikai', '8 Általános', 1 FROM dual
 UNION ALL

 SELECT 8, 'Fizikai', '8 Általános', 22 FROM dual
 UNION ALL

 SELECT 9, 'Fizikai', '8 Általános', 31 FROM dual
 UNION ALL

 SELECT 10, 'Fizikai', '8 Általános', 15 FROM dual
 UNION ALL

 SELECT 11, 'Fizikai', '8 Általános', 38 FROM dual
 UNION ALL

 SELECT 12, 'Fizikai', '8 Általános', 10 FROM dual
 UNION ALL

 SELECT 13, 'Fizikai', '8 Általános', 37 FROM dual
 UNION ALL

 SELECT 14, 'Irodai', '8 Általános', 35 FROM dual
 UNION ALL

 SELECT 15, 'Irodai', '8 Általános', NULL FROM dual
 UNION ALL

 SELECT 16, 'Irodai', '8 Általános', 7 FROM dual
 UNION ALL

 SELECT 17, 'Irodai', 'Érettségi', NULL FROM dual
 UNION ALL

 SELECT 18, 'Irodai', 'Érettségi', 4 FROM dual
 UNION ALL

 SELECT 19, 'Irodai', 'Érettségi', 2 FROM dual
 UNION ALL

 SELECT 20, 'Irodai', 'Érettségi', 26 FROM dual
 UNION ALL

 SELECT 21, 'Irodai', 'Érettségi', 8 FROM dual
 UNION ALL

 SELECT 22, 'Irodai', 'Érettségi', 43 FROM dual
 UNION ALL

 SELECT 23, 'Irodai', 'Érettségi', 16 FROM dual
 UNION ALL

 SELECT 24, 'Irodai', 'Diploma', 44 FROM dual
 UNION ALL

 SELECT 25, 'Irodai', 'Diploma', NULL FROM dual
 UNION ALL

 SELECT 26, 'Irodai', 'Diploma', 41 FROM dual
 UNION ALL

 SELECT 27, 'Irodai', 'Diploma', 33 FROM dual
 UNION ALL

 SELECT 28, 'Irodai', 'Diploma', 34 FROM dual
 UNION ALL

 SELECT 29, 'Irodai', 'Diploma', 39 FROM dual
 UNION ALL

 SELECT 30, 'Fizikai', 'Diploma', 12 FROM dual
 UNION ALL

 SELECT 31, 'Fizikai', 'Diploma', NULL FROM dual
 UNION ALL

 SELECT 32, 'Fizikai', 'Diploma', 18 FROM dual
 UNION ALL

 SELECT 33, 'Fizikai', 'Diploma', 9 FROM dual
 UNION ALL

 SELECT 34, 'Fizikai', 'Diploma', 6 FROM dual
 UNION ALL

 SELECT 35, 'Fizikai', 'Diploma', 11 FROM dual
 UNION ALL

 SELECT 36, 'Fizikai', 'Diploma', 45 FROM dual
 UNION ALL

 SELECT 37, 'Fizikai', 'Diploma', 28 FROM dual
 UNION ALL

 SELECT 38, 'Fizikai', 'Diploma', 23 FROM dual
 UNION ALL

 SELECT 39, 'Fizikai', 'Diploma', 32 FROM dual
 UNION ALL

 SELECT 40, 'Fizikai', 'Diploma', 17 FROM dual
 UNION ALL

 SELECT 41, 'Fizikai', 'Diploma', 14 FROM dual
 UNION ALL

 SELECT 42, 'Fizikai', '8 Általános', 24 FROM dual
 UNION ALL

 SELECT 43, 'Fizikai', '8 Általános', 36 FROM dual
 UNION ALL

 SELECT 44, 'Fizikai', '8 Általános', 40 FROM dual
 UNION ALL

 SELECT 45, 'Fizikai', '8 Általános', 5 FROM dual
 UNION ALL

 SELECT 46, 'Fizikai', '8 Általános', 29 FROM dual
 UNION ALL

 SELECT 47, 'Irodai', 'Érettségi', 20 FROM dual
 UNION ALL

 SELECT 48, 'Irodai', 'Érettségi', 42 FROM dual
 UNION ALL

 SELECT 49, 'Irodai', 'Érettségi', 30 FROM dual
 UNION ALL

 SELECT 50, 'Irodai', 'Diploma', 13 FROM dual
 UNION ALL

 SELECT 51, 'Irodai', 'Diploma', 19 FROM dual
 UNION ALL

 SELECT 52, 'Irodai', 'Diploma', 3 FROM dual
 UNION ALL

 SELECT 53, 'Irodai', 'Diploma', 25 FROM dual
 UNION ALL

 SELECT 54, 'Irodai', 'Diploma', 48 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `normal_felhasznalo`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE normal_felhasznalo';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `normal_felhasznalo`
--

INSERT INTO normal_felhasznalo (id, fiokadatok_id, vegzettseg_id, vallalat_id)
 SELECT 1, 2, 50, NULL FROM dual
 UNION ALL

 SELECT 2, 3, 55, 22 FROM dual
 UNION ALL

 SELECT 3, 5, 39, 21 FROM dual
 UNION ALL

 SELECT 4, 7, 83, NULL FROM dual
 UNION ALL

 SELECT 5, 8, 8, NULL FROM dual
 UNION ALL

 SELECT 6, 10, 5, NULL FROM dual
 UNION ALL

 SELECT 7, 11, 11, 12 FROM dual
 UNION ALL

 SELECT 8, 12, 81, NULL FROM dual
 UNION ALL

 SELECT 9, 13, 51, 3 FROM dual
 UNION ALL

 SELECT 10, 14, 95, NULL FROM dual
 UNION ALL

 SELECT 11, 15, 67, NULL FROM dual
 UNION ALL

 SELECT 12, 16, 72, 19 FROM dual
 UNION ALL

 SELECT 13, 18, 35, 28 FROM dual
 UNION ALL

 SELECT 14, 19, 42, NULL FROM dual
 UNION ALL

 SELECT 15, 20, 82, 20 FROM dual
 UNION ALL

 SELECT 16, 21, 25, NULL FROM dual
 UNION ALL

 SELECT 17, 22, 24, 25 FROM dual
 UNION ALL

 SELECT 18, 23, 82, NULL FROM dual
 UNION ALL

 SELECT 19, 26, 64, 14 FROM dual
 UNION ALL

 SELECT 20, 28, 47, NULL FROM dual
 UNION ALL

 SELECT 21, 34, 39, NULL FROM dual
 UNION ALL

 SELECT 22, 35, 10, 28 FROM dual
 UNION ALL

 SELECT 23, 37, 49, NULL FROM dual
 UNION ALL

 SELECT 24, 38, 56, 1 FROM dual
 UNION ALL

 SELECT 25, 39, 93, 18 FROM dual
 UNION ALL

 SELECT 26, 40, 72, NULL FROM dual
 UNION ALL

 SELECT 27, 41, 36, 6 FROM dual
 UNION ALL

 SELECT 28, 42, 70, NULL FROM dual
 UNION ALL

 SELECT 29, 43, 36, NULL FROM dual
 UNION ALL

 SELECT 30, 45, 59, 5 FROM dual
 UNION ALL

 SELECT 31, 47, 64, 30 FROM dual
 UNION ALL

 SELECT 32, 48, 14, 20 FROM dual
 UNION ALL

 SELECT 33, 49, 9, NULL FROM dual
 UNION ALL

 SELECT 34, 53, 20, 17 FROM dual
 UNION ALL

 SELECT 35, 54, 11, 9 FROM dual
 UNION ALL

 SELECT 36, 57, 64, 11 FROM dual
 UNION ALL

 SELECT 37, 58, 78, NULL FROM dual
 UNION ALL

 SELECT 38, 59, 8, 4 FROM dual
 UNION ALL

 SELECT 39, 61, 24, 25 FROM dual
 UNION ALL

 SELECT 40, 65, 84, 21 FROM dual
 UNION ALL

 SELECT 41, 66, 12, 7 FROM dual
 UNION ALL

 SELECT 42, 67, 12, NULL FROM dual
 UNION ALL

 SELECT 43, 68, 65, 25 FROM dual
 UNION ALL

 SELECT 44, 69, 91, 27 FROM dual
 UNION ALL

 SELECT 45, 70, 28, NULL FROM dual
 UNION ALL

 SELECT 46, 71, 93, 22 FROM dual
 UNION ALL

 SELECT 47, 72, 17, 10 FROM dual
 UNION ALL

 SELECT 48, 73, 37, NULL FROM dual
 UNION ALL

 SELECT 49, 75, 47, 10 FROM dual
 UNION ALL

 SELECT 50, 77, 49, 29 FROM dual
 UNION ALL

 SELECT 51, 79, 78, NULL FROM dual
 UNION ALL

 SELECT 52, 80, 55, 11 FROM dual
 UNION ALL

 SELECT 53, 82, 24, 13 FROM dual
 UNION ALL

 SELECT 54, 84, 21, NULL FROM dual
 UNION ALL

 SELECT 55, 88, 58, 5 FROM dual
 UNION ALL

 SELECT 56, 90, 63, 25 FROM dual
 UNION ALL

 SELECT 57, 91, 44, NULL FROM dual
 UNION ALL

 SELECT 58, 94, 37, 1 FROM dual
 UNION ALL

 SELECT 59, 95, 37, 26 FROM dual
 UNION ALL

 SELECT 60, 96, 20, 17 FROM dual
 UNION ALL

 SELECT 61, 99, 70, NULL FROM dual
 UNION ALL

 SELECT 62, 100, 78, NULL FROM dual
 UNION ALL

 SELECT 63, 102, 69, 11 FROM dual
 UNION ALL

 SELECT 64, 104, 43, NULL FROM dual
 UNION ALL

 SELECT 65, 105, 76, 1 FROM dual
 UNION ALL

 SELECT 66, 106, 70, 14 FROM dual
 UNION ALL

 SELECT 67, 111, 64, NULL FROM dual
 UNION ALL

 SELECT 68, 112, 21, 25 FROM dual
 UNION ALL

 SELECT 69, 113, 68, 22 FROM dual
 UNION ALL

 SELECT 70, 115, 55, 4 FROM dual
 UNION ALL

 SELECT 71, 116, 56, 18 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `regisztralt_allasok`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE regisztralt_allasok';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `regisztralt_allasok`
--

INSERT INTO regisztralt_allasok (allas_id, diakszovetkezet_id)
 ...
 SELECT 37, 1 FROM dual
 UNION ALL

 SELECT 45, 5 FROM dual
 UNION ALL

 SELECT 57, 4 FROM dual
 UNION ALL

 SELECT 60, 1 FROM dual
 UNION ALL

 SELECT 64, 4 FROM dual
 UNION ALL

 SELECT 68, 1 FROM dual
 UNION ALL

 SELECT 71, 4 FROM dual
 UNION ALL

 SELECT 75, 1 FROM dual
 UNION ALL

 SELECT 78, 5 FROM dual
 UNION ALL

 SELECT 79, 5 FROM dual
 UNION ALL

 SELECT 85, 2 FROM dual
 UNION ALL

 SELECT 95, 3 FROM dual
 UNION ALL

 SELECT 99, 2 FROM dual
 UNION ALL
...
--
-- SQLINES DEMO *** ehhez a táblához `szemelyes_adatok`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE szemelyes_adatok';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
CREATE TABLE szemelyes_adatok (
  id number(10) NOT NULL,
  nev varchar2(50) NOT NULL,
  szuletesi_datum timestamp(0) NOT NULL
) ;

--
-- SQLINES DEMO *** k kiíratása `szemelyes_adatok`
--

INSERT INTO szemelyes_adatok (id, nev, szuletesi_datum)
 SELECT 1, 'Váradi Alexander', '1970-04-26 00:00:00' FROM dual
 UNION ALL

 SELECT 2, 'Kocsis Márk', '1974-12-11 00:00:00' FROM dual
 UNION ALL

 SELECT 3, 'Király Péter', '1976-08-13 00:00:00' FROM dual
 UNION ALL

 SELECT 4, 'Takács Gergely', '1977-06-06 00:00:00' FROM dual
 UNION ALL

 SELECT 5, 'Fekete Dénes', '1979-03-18 00:00:00' FROM dual
 UNION ALL

 SELECT 6, 'Bogdán Benjamin', '1980-01-16 00:00:00' FROM dual
 UNION ALL

 SELECT 7, 'Szőke Máté', '1981-07-03 00:00:00' FROM dual
 UNION ALL

 SELECT 8, 'Szűts Szilveszter', '1982-11-10 00:00:00' FROM dual
 UNION ALL

 SELECT 9, 'Nemes Benjámin', '1983-01-28 00:00:00' FROM dual
 UNION ALL

 SELECT 10, 'Balogh Géza', '1984-11-13 00:00:00' FROM dual
 UNION ALL

 SELECT 11, 'Miksa Barnabás', '1986-01-13 00:00:00' FROM dual
 UNION ALL

 SELECT 12, 'Papp Adrián', '1987-07-27 00:00:00' FROM dual
 UNION ALL

 SELECT 13, 'Fekete András', '1993-01-27 00:00:00' FROM dual
 UNION ALL

 SELECT 14, 'László Bence', '1993-07-29 00:00:00' FROM dual
 UNION ALL

 SELECT 15, 'Apród Ádám', '1993-08-12 00:00:00' FROM dual
 UNION ALL

 SELECT 16, 'Faragó Kornél', '1993-11-29 00:00:00' FROM dual
 UNION ALL

 SELECT 17, 'Szekeres Károly', '1994-07-01 00:00:00' FROM dual
 UNION ALL

 SELECT 18, 'Sándor Patrik', '1994-11-07 00:00:00' FROM dual
 UNION ALL

 SELECT 19, 'Szücs Dénes', '1995-02-06 00:00:00' FROM dual
 UNION ALL

 SELECT 20, 'Váradi Barna', '1996-03-21 00:00:00' FROM dual
 UNION ALL

 SELECT 21, 'Kende Albert', '1996-09-15 00:00:00' FROM dual
 UNION ALL

 SELECT 22, 'Mezei Alex', '1997-06-23 00:00:00' FROM dual
 UNION ALL

 SELECT 23, 'Balogh Adrián', '2000-08-03 00:00:00' FROM dual
 UNION ALL

 SELECT 24, 'Barna Ádám', '2001-02-08 00:00:00' FROM dual
 UNION ALL

 SELECT 25, 'Tamás Vilmos', '2001-03-28 00:00:00' FROM dual
 UNION ALL

 SELECT 26, 'Zobor Benedek', '1972-10-16 00:00:00' FROM dual
 UNION ALL

 SELECT 27, 'Bálint Máté', '1973-09-29 00:00:00' FROM dual
 UNION ALL

 SELECT 28, 'Apród Dominik', '1974-09-19 00:00:00' FROM dual
 UNION ALL

 SELECT 29, 'Fehér Noel', '1975-08-21 00:00:00' FROM dual
 UNION ALL

 SELECT 30, 'Illés Olivér', '1978-07-10 00:00:00' FROM dual
 UNION ALL

 SELECT 31, 'Balog Gergely', '1978-08-27 00:00:00' FROM dual
 UNION ALL

 SELECT 32, 'Fazekas Tibor', '1979-01-19 00:00:00' FROM dual
 UNION ALL

 SELECT 33, 'Balogh Donát', '1979-11-22 00:00:00' FROM dual
 UNION ALL

 SELECT 34, 'Veres Milán', '1979-12-14 00:00:00' FROM dual
 UNION ALL

 SELECT 35, 'Csonka Renátó', '1980-12-28 00:00:00' FROM dual
 UNION ALL

 SELECT 36, 'Lukács Levente', '1984-07-12 00:00:00' FROM dual
 UNION ALL

 SELECT 37, 'Bogdán Szilveszter', '1985-02-18 00:00:00' FROM dual
 UNION ALL

 SELECT 38, 'Dudás Kálmán', '1989-09-22 00:00:00' FROM dual
 UNION ALL

 SELECT 39, 'Virág Vince', '1991-08-17 00:00:00' FROM dual
 UNION ALL

 SELECT 40, 'Simon Benjámin', '1992-03-18 00:00:00' FROM dual
 UNION ALL

 SELECT 41, 'Tamás Szilveszter', '1992-06-28 00:00:00' FROM dual
 UNION ALL

 SELECT 42, 'Soós István', '1995-02-05 00:00:00' FROM dual
 UNION ALL

 SELECT 43, 'Papp Benjámin', '1995-08-20 00:00:00' FROM dual
 UNION ALL

 SELECT 44, 'Szekeres Károly', '1995-11-25 00:00:00' FROM dual
 UNION ALL

 SELECT 45, 'Orsós Gábor', '1996-04-22 00:00:00' FROM dual
 UNION ALL

 SELECT 46, 'Halász Ferenc', '1997-09-14 00:00:00' FROM dual
 UNION ALL

 SELECT 47, 'Szabó Róbert', '1999-03-22 00:00:00' FROM dual
 UNION ALL

 SELECT 48, 'Vörös Lajos', '1999-12-25 00:00:00' FROM dual
 UNION ALL

 SELECT 49, 'László Viktor', '2000-05-27 00:00:00' FROM dual
 UNION ALL

 SELECT 50, 'Sípos Balázs', '2000-06-05 00:00:00' FROM dual
 UNION ALL

 SELECT 51, 'Csatár Patrícia', '1972-04-16 00:00:00' FROM dual
 UNION ALL

 SELECT 52, 'Egyed Borbála', '1976-10-29 00:00:00' FROM dual
 UNION ALL

 SELECT 53, 'Török Erzsébet', '1977-01-07 00:00:00' FROM dual
 UNION ALL

 SELECT 54, 'László Kitti', '1977-04-13 00:00:00' FROM dual
 UNION ALL

 SELECT 55, 'Major Laura', '1978-07-31 00:00:00' FROM dual
 UNION ALL

 SELECT 56, 'Németh Vanda', '1979-10-09 00:00:00' FROM dual
 UNION ALL

 SELECT 57, 'Bálint Viktória', '1979-11-08 00:00:00' FROM dual
 UNION ALL

 SELECT 58, 'Király Cintia', '1983-08-26 00:00:00' FROM dual
 UNION ALL

 SELECT 59, 'Pap Éva', '1983-09-24 00:00:00' FROM dual
 UNION ALL

 SELECT 60, 'Biró Petra', '1983-10-07 00:00:00' FROM dual
 UNION ALL

 SELECT 61, 'Szalai Fanni', '1983-12-23 00:00:00' FROM dual
 UNION ALL

 SELECT 62, 'Balázs Adrienn', '1985-06-09 00:00:00' FROM dual
 UNION ALL

 SELECT 63, 'Apród Nóra', '1985-08-03 00:00:00' FROM dual
 UNION ALL

 SELECT 64, 'Kapolcs Anita', '1986-09-18 00:00:00' FROM dual
 UNION ALL

 SELECT 65, 'Hegedüs Éva', '1988-03-28 00:00:00' FROM dual
 UNION ALL

 SELECT 66, 'Máté Adél', '1992-05-06 00:00:00' FROM dual
 UNION ALL

 SELECT 67, 'Magyar Gréta', '1992-08-11 00:00:00' FROM dual
 UNION ALL

 SELECT 68, 'Székely Ivett', '1994-05-24 00:00:00' FROM dual
 UNION ALL

 SELECT 69, 'Egyed Judit', '1995-01-15 00:00:00' FROM dual
 UNION ALL

 SELECT 70, 'Németh Virág', '1995-06-13 00:00:00' FROM dual
 UNION ALL

 SELECT 71, 'Pap Zita', '1995-09-26 00:00:00' FROM dual
 UNION ALL

 SELECT 72, 'Fodor Dorottya', '1996-11-07 00:00:00' FROM dual
 UNION ALL

 SELECT 73, 'Juhász Anna', '1998-11-13 00:00:00' FROM dual
 UNION ALL

 SELECT 74, 'Székely Bettina', '2000-05-10 00:00:00' FROM dual
 UNION ALL

 SELECT 75, 'Fekete Petra', '2000-06-10 00:00:00' FROM dual
 UNION ALL

 SELECT 76, 'Király Zsófia', '1970-08-23 00:00:00' FROM dual
 UNION ALL

 SELECT 77, 'Jónás Rebeka', '1973-01-07 00:00:00' FROM dual
 UNION ALL

 SELECT 78, 'Kovács Noémi', '1973-12-30 00:00:00' FROM dual
 UNION ALL

 SELECT 79, 'Antal Flóra', '1974-12-07 00:00:00' FROM dual
 UNION ALL

 SELECT 80, 'Barta Veronika', '1975-10-23 00:00:00' FROM dual
 UNION ALL

 SELECT 81, 'Faragó Petra', '1975-11-09 00:00:00' FROM dual
 UNION ALL

 SELECT 82, 'Balla Mercédesz', '1976-04-05 00:00:00' FROM dual
 UNION ALL

 SELECT 83, 'Fülöp Dóra', '1978-04-14 00:00:00' FROM dual
 UNION ALL

 SELECT 84, 'Török Anna', '1981-10-10 00:00:00' FROM dual
 UNION ALL

 SELECT 85, 'Pataki Vivien', '1982-06-17 00:00:00' FROM dual
 UNION ALL

 SELECT 86, 'Szekeres Klaudia', '1983-08-26 00:00:00' FROM dual
 UNION ALL

 SELECT 87, 'Balázs Lili', '1984-04-15 00:00:00' FROM dual
 UNION ALL

 SELECT 88, 'Gál Barbara', '1984-08-17 00:00:00' FROM dual
 UNION ALL

 SELECT 89, 'Fazekas Regina', '1985-04-16 00:00:00' FROM dual
 UNION ALL

 SELECT 90, 'Orsós Dalma', '1985-04-18 00:00:00' FROM dual
 UNION ALL

 SELECT 91, 'Antal Zita', '1985-11-24 00:00:00' FROM dual
 UNION ALL

 SELECT 92, 'Pál Nikolett', '1986-08-23 00:00:00' FROM dual
 UNION ALL

 SELECT 93, 'Simon Vivien', '1987-05-07 00:00:00' FROM dual
 UNION ALL

 SELECT 94, 'Szalai Natália', '1989-09-29 00:00:00' FROM dual
 UNION ALL

 SELECT 95, 'Váradi Evelin', '1992-08-20 00:00:00' FROM dual
 UNION ALL

 SELECT 96, 'Kerekes Virág', '1994-04-09 00:00:00' FROM dual
 UNION ALL

 SELECT 97, 'Oláh Réka', '1995-08-31 00:00:00' FROM dual
 UNION ALL

 SELECT 98, 'Barta Bernadett', '1995-11-04 00:00:00' FROM dual
 UNION ALL

 SELECT 99, 'Jónás Dorina', '1997-04-14 00:00:00' FROM dual
 UNION ALL

 SELECT 100, 'Orosz Mária', '1998-04-19 00:00:00' FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `vallalat`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE vallalat';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `vallalat`
--

INSERT INTO vallalat (id, neve, tulajdonos, jegyzett_toke, ertekeles)
 SELECT 1, 'Digital Intelligence Systems, LLC', 'Chantelle Workman', 664283306, 3 FROM dual
 UNION ALL

 SELECT 2, 'University of Chicago/IT Services', 'Zaine Powers', 376467583, 5 FROM dual
 UNION ALL

 SELECT 3, 'Galaxy Systems, Inc.', 'Kingston Easton', 125007618, 5 FROM dual
 UNION ALL

 SELECT 4, 'TransTech LLC', 'Eddison Fields', 132876152, 0 FROM dual
 UNION ALL

 SELECT 5, 'Matrix Resources', 'Kyal Mora', 340995392, 4 FROM dual
 UNION ALL

 SELECT 6, 'Yash Technologies', 'Evie-Mai Dean', 948377827, 3 FROM dual
 UNION ALL

 SELECT 7, 'Noble1', 'Ameena Arellano', 734234738, 0 FROM dual
 UNION ALL

 SELECT 8, 'Bluebeam Software, Inc.', 'Misbah Brookes', 387060163, 1 FROM dual
 UNION ALL

 SELECT 9, 'Genesis10', 'Amira Dennis', 276888031, 5 FROM dual
 UNION ALL

 SELECT 10, 'VanderHouwen & Associates, Inc.', 'Alena Ahmed', 109582896, 5 FROM dual
 UNION ALL

 SELECT 11, 'Maxonic, Inc.', 'Iona Sutherland', 920635916, 0 FROM dual
 UNION ALL

 SELECT 12, 'CSI (Consultant Specialists Inc.)', 'Mary Tillman', 231829834, 3 FROM dual
 UNION ALL

 SELECT 13, 'Eastridge Workforce Solutions', 'Umayr Duggan', 734650775, 3 FROM dual
 UNION ALL

 SELECT 14, 'Collabera', 'Alayah Stevens', 132932128, 0 FROM dual
 UNION ALL

 SELECT 15, 'Fahrenheit IT Staffing & Consulting', 'Cecilia Hudson', 898213739, 3 FROM dual
 UNION ALL

 SELECT 16, 'Avesta Computer Services', 'Samantha Moody', 650629952, 3 FROM dual
 UNION ALL

 SELECT 17, 'Amazon', 'Calista Head', 361453390, 3 FROM dual
 UNION ALL

 SELECT 18, 'ReqRoute, Inc', 'Willow Bull', 638187944, 2 FROM dual
 UNION ALL

 SELECT 19, 'Turnberry Solutions', 'Lucinda Dawson', 751963708, 0 FROM dual
 UNION ALL

 SELECT 20, 'Alpha Recruitment', 'Eshan Osborne', 690987693, 0 FROM dual
 UNION ALL

 SELECT 21, 'Etouch Systems Corp', 'Emelia Lancaster', 564598055, 3 FROM dual
 UNION ALL

 SELECT 22, 'Centizen', 'Payton Luna', 620070215, 1 FROM dual
 UNION ALL

 SELECT 23, 'Mygo Consulting', 'Cristian Bentley', 24232819, 3 FROM dual
 UNION ALL

 SELECT 24, 'Alpha Consulting Corp.', 'Tyler-Jay Singleton', 819990547, 0 FROM dual
 UNION ALL

 SELECT 25, 'Ascent', 'Ismaeel Pearce', 936106096, 2 FROM dual
 UNION ALL

 SELECT 26, 'Amerit Consulting', 'Meerab Rudd', 216242848, 4 FROM dual
 UNION ALL

 SELECT 27, 'Tellus Solutions', 'Teri Herman', 804244313, 0 FROM dual
 UNION ALL

 SELECT 28, 'Stratitude Inc', 'Carson Henderson', 153775101, 1 FROM dual
 UNION ALL

 SELECT 29, 'Xoriant Corporation', 'Ember Garner', 678025933, 1 FROM dual
 UNION ALL

 SELECT 30, 'iSpace, Inc', 'Mckenzie Huber', 328038583, 0 FROM dual;

-- SQLINES DEMO *** ---------------------------------------

--
-- SQLINES DEMO *** ehhez a táblához `vegzettseg`
--

BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE vegzettseg';
EXCEPTION
   WHEN OTHERS THEN NULL;
END;
/
...
--
-- SQLINES DEMO *** k kiíratása `vegzettseg`
--

INSERT INTO vegzettseg (id, nev, intezmeny)
 SELECT 1, 'Egyetem, BSC', 'Bridgeport International Academy' FROM dual
 UNION ALL

 SELECT 2, 'Technikum', 'Carmel Acadmey' FROM dual
 UNION ALL

 SELECT 3, 'Egyetem, MSC', 'Country Kids Club' FROM dual
 UNION ALL

 SELECT 4, 'Egyetem, MSC', 'Eagle Hill School' FROM dual
 UNION ALL

 SELECT 5, 'Technikum', 'Easton Country Day School' FROM dual
 UNION ALL

 SELECT 6, 'Egyetem, BSC', 'Fairfield County Sda School' FROM dual
 UNION ALL

 SELECT 7, 'Szakközépiskola', 'Fraser Woods Montessori School' FROM dual
 UNION ALL

 SELECT 8, 'Egyetem, BSC', 'Giant Steps Connecticut' FROM dual
 UNION ALL

 SELECT 9, 'Egyetem, BSC', 'Housatonic Valley Waldorf School' FROM dual
 UNION ALL

 SELECT 10, 'Gimnázium', 'Landmark Preschool' FROM dual
 UNION ALL

 SELECT 11, 'Egyetem, BSC', 'Abercorn International School' FROM dual
 UNION ALL

 SELECT 12, 'Gimnázium', 'Landmark Preschool' FROM dual
 UNION ALL

 SELECT 13, 'Szakközépiskola', 'Our Lady Of Grace Nursery School & Kindergarten' FROM dual
 UNION ALL

 SELECT 14, 'Egyetem, BSC', 'Our Lady Star Of The Sea School' FROM dual
 UNION ALL

 SELECT 15, 'Egyetem, MSC', 'Pierrepont School' FROM dual
 UNION ALL

 SELECT 16, 'Gimnázium', 'St Catherine Academy' FROM dual
 UNION ALL

 SELECT 17, 'Egyetem, MSC', 'St Jude School' FROM dual
 UNION ALL

 SELECT 18, 'Egyetem, BSC', 'St Mary School' FROM dual
 UNION ALL

 SELECT 19, 'Gimnázium', 'St Theresa School' FROM dual
 UNION ALL

 SELECT 20, 'Technikum', 'St Vincent' FROM dual Special Needs Services'),
