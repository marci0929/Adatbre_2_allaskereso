...
DROP TABLE "C##ADATB"."PASSCHANGE" cascade constraints;
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table PASSCHANGE
--------------------------------------------------------

  CREATE TABLE "C##ADATB"."PASSCHANGE" 
   (	"EMAIL" VARCHAR2(200 BYTE), 
	"OLDPASS" VARCHAR2(200 BYTE), 
	"NEWPASS" VARCHAR2(200 BYTE)
...
REM INSERTING into C##ADATB.PASSCHANGE
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Trigger PASS_CHANGE_DETECT
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "C##ADATB"."PASS_CHANGE_DETECT" 
AFTER UPDATE OF JELSZO
ON FIOKADATOK
FOR EACH ROW
BEGIN
    INSERT INTO PASSCHANGE VALUES (:OLD.EMAIL, :OLD.JELSZO, :NEW.JELSZO);
END;
/
ALTER TRIGGER "C##ADATB"."PASS_CHANGE_DETECT" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PASS_CHANGE_DETECT
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ADATB"."ALLAS" ADD CONSTRAINT "ALLAS_FK1" FOREIGN KEY ("MUNKAKOR_ID")
	  REFERENCES "C##ADATB"."MUNKAKOR" ("ID") ON DELETE SET NULL ENABLE;
  ALTER TABLE "C##ADATB"."ALLAS" ADD CONSTRAINT "ALLAS_FK2" FOREIGN KEY ("HIRDETO_ID")
	  REFERENCES "C##ADATB"."HIRDETO" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "C##ADATB"."ALLAS" ADD CONSTRAINT "ALLAS_FK3" FOREIGN KEY ("KAPCSOLAT_ID")
	  REFERENCES "C##ADATB"."KAPCSOLAT" ("ID") ON DELETE SET NULL ENABLE;
  ALTER TABLE "C##ADATB"."ALLAS" ADD CONSTRAINT "ALLAS_FK4" FOREIGN KEY ("HELYSZIN_ID")
	  REFERENCES "C##ADATB"."HELYSZIN" ("ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ADATB"."DIAKSZOVETKEZETNEL_VAN" ADD CONSTRAINT "DIAKSZOVETKEZETNEL_VAN_FK1" FOREIGN KEY ("DIAKSZOVETKEZET_ID")
	  REFERENCES "C##ADATB"."DIAKSZOVETKEZET" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "C##ADATB"."DIAKSZOVETKEZETNEL_VAN" ADD CONSTRAINT "DIAKSZOVETKEZETNEL_VAN_FK2" FOREIGN KEY ("DIAK_FELHASZNALO_ID")
	  REFERENCES "C##ADATB"."DIAK_FELHASZNALO" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ADATB"."FIOKADATOK" ADD CONSTRAINT "FIOKADATOK_FK1" FOREIGN KEY ("SZEMELYES_ADATOK_ID")
	  REFERENCES "C##ADATB"."SZEMELYES_ADATOK" ("ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ADATB"."JELENTKEZOK" ADD CONSTRAINT "JELENTKEZOK_FK1" FOREIGN KEY ("ALLAS_ID")
	  REFERENCES "C##ADATB"."ALLAS" ("ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "C##ADATB"."JELENTKEZOK" ADD CONSTRAINT "JELENTKEZOK_FK2" FOREIGN KEY ("NORMAL_FELHASZNALO_ID")
	  REFERENCES "C##ADATB"."NORMAL_FELHASZNALO" ("ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ADATB"."MUNKAKOR" ADD CONSTRAINT "MUNKAKOR_FK1" FOREIGN KEY ("EGYEB_FELTETELEK_ID")
	  REFERENCES "C##ADATB"."EGYEB_FELTETELEK" ("ID") ON DELETE SET NULL ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "C##ADATB"."NORMAL_FELHASZNALO" ADD CONSTRAINT "NORMAL_FELHASZNALO_FK2" FOREIGN KEY ("VEGZETTSEG_ID")
	  REFERENCES "C##ADATB"."VEGZETTSEG" ("ID") ON DELETE SET NULL ENABLE;
